...
public class TextSearch {
    public static void main(String[] args) {
        ...
        System.out.println("\nmatches method returns *** " + matches + " *** on '^miss(.*)'");
        ...
        // no match found
        // toffset - where to start in string
        // other - what string is matched to
        // ooffset - where to start in substring to be matched
        // len - number of chars to use in given substring
