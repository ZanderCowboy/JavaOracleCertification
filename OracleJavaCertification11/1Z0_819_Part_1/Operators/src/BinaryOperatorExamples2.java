...
public class BinaryOperatorExamples2 {
    public static void main(String[] args) {
        ...
        if (a == c) {
            System.out.println("Printed: a and c primitive values are equal"); // true
        }
        if (a != b) {
            System.out.println("Printed: a and b are not equal because primitive" +
                    " data values are not equal"); // printed
        }
        ...
        String s3 = s2.intern();
        if (s1 == s3) {
            System.out.println("Printed: Strings are equal if they are interned or are String literals"); // printed
        }
        if (s1 != s2) {
            System.out.println("Printed: Otherwise String objects are not equal"); // printed
        }
        ...
        if (o1 == o2) {
            System.out.println("Printed: Objects are equal if they reference same object"); // printed
        }
        if (o1 != o3) {
            System.out.println("Printed: Otherwise  objects are not equal"); // printed
        }
