...
//    }
    ...
    static {
        ...
        try {
            // We force an error for demonstration purposes
            if ((10 / currentVal) > 0) { // Error, exception thrown
                System.out.println("Whoops");
            }
        } catch (Exception e) {
            System.out.println("Caught the error");
//            throw new Exception("Got some error in the class initialization"); // Checked exception; not handled
...
//        try {
//            System.out.println(StaticTest.currentMessage);
//        } catch (Exception e) { // the error is never caught
