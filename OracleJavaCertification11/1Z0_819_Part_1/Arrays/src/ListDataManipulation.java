...
public class ListDataManipulation {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(primaryColors));
        ...
        List<String> colorList1 = new ArrayList<>(Arrays.asList(primaryColors));
        ...
        // List reference
        colorList.replaceAll((str) -> str + "ish");
