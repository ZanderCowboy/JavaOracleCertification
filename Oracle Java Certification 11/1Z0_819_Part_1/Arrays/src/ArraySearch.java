...
public class ArraySearch {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(partialFirstString));
        System.out.println("Arrays.mismatch(firstString,partialFirstString) = "
                + Arrays.mismatch(firstString, partialFirstString));

        // Try another example...
        System.out.println(Arrays.toString(firstStringUnsortedDuplicates));
        System.out.println("new String[]{\"jkl\",\"mno\"}");
        ...
        System.out.println(Arrays.toString(anotherUnsortedSet));
