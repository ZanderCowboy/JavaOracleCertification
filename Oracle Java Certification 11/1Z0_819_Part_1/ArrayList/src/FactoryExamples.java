...
//        copiedList = List.copyOf(originalList); // not possible because of NULL

        copiedList = List.copyOf(originalList.subList(0, 5)); // bypassing NULL
        System.out.println(copiedList);
...
//        copiedList = List.<String>of(stringArray); // original line
        copiedList = List.of(stringArray);
        System.out.println(copiedList);
