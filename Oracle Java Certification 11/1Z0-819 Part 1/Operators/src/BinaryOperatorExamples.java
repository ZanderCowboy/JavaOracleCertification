...
public class BinaryOperatorExamples {
    public static void main(String[] args) {
        ...
        a = 0;
        b = 10;
        if ((++a > b) & (++a >= b)) { // 1 > 10 & 1 >= 10: false & false
            System.out.println("Evaluation [(++a > b) & (++a >= b)] met"); //  not printed
        }
        ...
        a = 0;
        b = 0;
        if ((++a > b) && (++a >= b)) { // 1 > 0 && 1 >= 0: true && true
            System.out.println("Evaluation [(++a > b) & (++a >= b)] met"); // printed
        }
