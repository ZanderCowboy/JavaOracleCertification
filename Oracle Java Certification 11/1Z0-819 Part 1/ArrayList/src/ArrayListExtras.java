...
//        typedList.add(typedList.size()+1, new BaseClass("def")); // does not compile, since index is greater than size
...
//        typedList.set(0, typedSubList);
        rawList.set(0, typedSubList); // do not overlook; new item is a sublist
